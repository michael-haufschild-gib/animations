...
const ButtonEffectsRipple = lazy(() => import('./framer/ButtonEffectsRipple').then(m => ({ default: m.ButtonEffectsRipple })))
const ButtonEffectsJitter = lazy(() => import('./framer/ButtonEffectsJitter').then(m => ({ default: m.ButtonEffectsJitter })))
const ButtonEffectsLiquidMorph = lazy(() => import('./framer/ButtonEffectsLiquidMorph').then(m => ({ default: m.ButtonEffectsLiquidMorph })))
const ButtonEffectsShockwave = lazy(() => import('./framer/ButtonEffectsShockwave').then(m => ({ default: m.ButtonEffectsShockwave })))
const ButtonEffectsSplitReveal = lazy(() => import('./framer/ButtonEffectsSplitReveal').then(m => ({ default: m.ButtonEffectsSplitReveal })))

// Lazy load CSS components
const CssButtonEffectsRipple = lazy(() => import('./css/ButtonEffectsRipple').then(m => ({ default: m.ButtonEffectsRipple })))
const CssButtonEffectsJitter = lazy(() => import('./css/ButtonEffectsJitter').then(m => ({ default: m.ButtonEffectsJitter })))
const CssButtonEffectsLiquidMorph = lazy(() => import('./css/ButtonEffectsLiquidMorph').then(m => ({ default: m.ButtonEffectsLiquidMorph })))
const CssButtonEffectsShockwave = lazy(() => import('./css/ButtonEffectsShockwave').then(m => ({ default: m.ButtonEffectsShockwave })))
const CssButtonEffectsSplitReveal = lazy(() => import('./css/ButtonEffectsSplitReveal').then(m => ({ default: m.ButtonEffectsSplitReveal })))
