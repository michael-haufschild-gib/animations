import LightsCircleStatic1, { metadata as metadata1 } from './LightsCircleStatic1'
import LightsCircleStatic2, { metadata as metadata2 } from './LightsCircleStatic2'
import LightsCircleStatic3, { metadata as metadata3 } from './LightsCircleStatic3'
import LightsCircleStatic4, { metadata as metadata4 } from './LightsCircleStatic4'
import LightsCircleStatic5, { metadata as metadata5 } from './LightsCircleStatic5'
import LightsCircleStatic6, { metadata as metadata6 } from './LightsCircleStatic6'
import LightsCircleStatic7, { metadata as metadata7 } from './LightsCircleStatic7'
import LightsCircleStatic8, { metadata as metadata8 } from './LightsCircleStatic8'
