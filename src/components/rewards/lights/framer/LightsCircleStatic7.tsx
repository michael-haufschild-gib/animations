...
const bulbVariants = {
  ...
  show: {
    ...
    boxShadow: [
      ...
      `0 0 8px color-mix(in srgb, var(--bulb-on) 75%, transparent), 0 0 12px color-mix(in srgb, var(--bulb-on) 55%, transparent)`,
      `0 0 6px var(--bulb-on-glow60), 0 0 9px color-mix(in srgb, var(--bulb-on) 40%, transparent)`,
