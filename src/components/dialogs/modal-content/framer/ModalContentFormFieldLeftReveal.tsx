 ...
 */ export function ModalContentFormFieldLeftReveal() {
  return (
    <div className="modal-content-overlay" data-animation-id="modal-content__form-field-left-reveal">
      <m.div className="modal-content-modal" initial={{ scale: 0.88, y: -16, opacity: 0 }} animate={{ scale: [0.88, 1.02, 1], y: [-16, -4, 0], opacity: [0, 0.6, 1] }} transition={{ duration: 0.4, ease: [0.4, 0, 0.2, 1] as const, times: [0, 0.5, 1] }}>
        ...
        <div className="modal-content-body">
          ...
          <div className="modal-content-form">
            {[0, 1, 2].map((index) => (
              <m.div key={index} className="modal-content-field" initial={{ x: -32, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.5, delay: 0.3 + 0.09 * index, ease: [0.4, 0, 0.2, 1] as const }}>
