...
const StandardEffectsBlink = lazy(() =>
  import('./framer/StandardEffectsBlink').then((m) => ({ default: m.StandardEffectsBlink }))
)
const StandardEffectsBounce = lazy(() =>
  import('./framer/StandardEffectsBounce').then((m) => ({ default: m.StandardEffectsBounce }))
)
const StandardEffectsFade = lazy(() =>
  import('./framer/StandardEffectsFade').then((m) => ({ default: m.StandardEffectsFade }))
)
const StandardEffectsFlip = lazy(() =>
  import('./framer/StandardEffectsFlip').then((m) => ({ default: m.StandardEffectsFlip }))
)
const StandardEffectsFloat = lazy(() =>
  import('./framer/StandardEffectsFloat').then((m) => ({ default: m.StandardEffectsFloat }))
)
const StandardEffectsHeartbeat = lazy(() =>
  import('./framer/StandardEffectsHeartbeat').then((m) => ({ default: m.StandardEffectsHeartbeat }))
)
const StandardEffectsJello = lazy(() =>
  import('./framer/StandardEffectsJello').then((m) => ({ default: m.StandardEffectsJello }))
)
const StandardEffectsPop = lazy(() =>
  import('./framer/StandardEffectsPop').then((m) => ({ default: m.StandardEffectsPop }))
)
const StandardEffectsPulse = lazy(() =>
  import('./framer/StandardEffectsPulse').then((m) => ({ default: m.StandardEffectsPulse }))
)
const StandardEffectsPulseCircle = lazy(() =>
  import('./framer/StandardEffectsPulseCircle').then((m) => ({
    default: m.StandardEffectsPulseCircle,
  }))
)
const StandardEffectsPulseWave = lazy(() =>
  import('./framer/StandardEffectsPulseWave').then((m) => ({ default: m.StandardEffectsPulseWave }))
)
const StandardEffectsRadialPulse = lazy(() =>
  import('./framer/StandardEffectsRadialPulse').then((m) => ({
    default: m.StandardEffectsRadialPulse,
  }))
)
const StandardEffectsRubberBand = lazy(() =>
  import('./framer/StandardEffectsRubberBand').then((m) => ({
    default: m.StandardEffectsRubberBand,
  }))
)
const StandardEffectsScale = lazy(() =>
  import('./framer/StandardEffectsScale').then((m) => ({ default: m.StandardEffectsScale }))
)
const StandardEffectsShake = lazy(() =>
  import('./framer/StandardEffectsShake').then((m) => ({ default: m.StandardEffectsShake }))
)
...
const StandardEffectsSqueeze = lazy(() =>
  import('./framer/StandardEffectsSqueeze').then((m) => ({ default: m.StandardEffectsSqueeze }))
)
const StandardEffectsSwing = lazy(() =>
  import('./framer/StandardEffectsSwing').then((m) => ({ default: m.StandardEffectsSwing }))
)
const StandardEffectsTada = lazy(() =>
  import('./framer/StandardEffectsTada').then((m) => ({ default: m.StandardEffectsTada }))
)
const StandardEffectsWiggle = lazy(() =>
  import('./framer/StandardEffectsWiggle').then((m) => ({ default: m.StandardEffectsWiggle }))
)

// CSS - Lazy load components
const CssStandardEffectsBlink = lazy(() =>
  import('./css/StandardEffectsBlink').then((m) => ({ default: m.StandardEffectsBlink }))
)
const CssStandardEffectsBounce = lazy(() =>
  import('./css/StandardEffectsBounce').then((m) => ({ default: m.StandardEffectsBounce }))
)
const CssStandardEffectsFade = lazy(() =>
  import('./css/StandardEffectsFade').then((m) => ({ default: m.StandardEffectsFade }))
)
...
const CssStandardEffectsJello = lazy(() =>
  import('./css/StandardEffectsJello').then((m) => ({ default: m.StandardEffectsJello }))
)
const CssStandardEffectsPop = lazy(() =>
  import('./css/StandardEffectsPop').then((m) => ({ default: m.StandardEffectsPop }))
)
const CssStandardEffectsPulse = lazy(() =>
  import('./css/StandardEffectsPulse').then((m) => ({ default: m.StandardEffectsPulse }))
)
const CssStandardEffectsPulseCircle = lazy(() =>
  import('./css/StandardEffectsPulseCircle').then((m) => ({
    default: m.StandardEffectsPulseCircle,
  }))
)
const CssStandardEffectsPulseWave = lazy(() =>
  import('./css/StandardEffectsPulseWave').then((m) => ({ default: m.StandardEffectsPulseWave }))
)
const CssStandardEffectsRadialPulse = lazy(() =>
  import('./css/StandardEffectsRadialPulse').then((m) => ({
    default: m.StandardEffectsRadialPulse,
  }))
)
const CssStandardEffectsRubberBand = lazy(() =>
  import('./css/StandardEffectsRubberBand').then((m) => ({ default: m.StandardEffectsRubberBand }))
)
...
const CssStandardEffectsSpin = lazy(() =>
  import('./css/StandardEffectsSpin').then((m) => ({ default: m.StandardEffectsSpin }))
)
const CssStandardEffectsSqueeze = lazy(() =>
  import('./css/StandardEffectsSqueeze').then((m) => ({ default: m.StandardEffectsSqueeze }))
)
const CssStandardEffectsScale = lazy(() =>
  import('./css/StandardEffectsScale').then((m) => ({ default: m.StandardEffectsScale }))
)
const CssStandardEffectsSlide = lazy(() =>
  import('./css/StandardEffectsSlide').then((m) => ({ default: m.StandardEffectsSlide }))
)
const CssStandardEffectsWiggle = lazy(() =>
  import('./css/StandardEffectsWiggle').then((m) => ({ default: m.StandardEffectsWiggle }))
)
const CssStandardEffectsTada = lazy(() =>
  import('./css/StandardEffectsTada').then((m) => ({ default: m.StandardEffectsTada }))
)
...
export const groupExport: GroupExport = {
  ...
  framer: {
    ...
    'standard-effects__radial-pulse': {
      component: StandardEffectsRadialPulse,
      metadata: radialPulseMeta,
    },
    'standard-effects__pulse-wave': {
      component: StandardEffectsPulseWave,
      metadata: pulseWaveMeta,
    },
    'standard-effects__rubber-band': {
      component: StandardEffectsRubberBand,
      metadata: rubberBandMeta,
    },
    ...
    'standard-effects__pulse-circle': {
  ...
  css: {
    ...
    'standard-effects__pulse-circle': {
      component: CssStandardEffectsPulseCircle,
      metadata: pulseCircleCssMeta,
    },
    'standard-effects__pulse-wave': {
      component: CssStandardEffectsPulseWave,
      metadata: pulseWaveCssMeta,
    },
    'standard-effects__radial-pulse': {
      component: CssStandardEffectsRadialPulse,
      metadata: radialPulseCssMeta,
    },
    'standard-effects__rubber-band': {
      component: CssStandardEffectsRubberBand,
